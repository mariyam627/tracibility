...
<div style={{width:'510px',height:'510px',backgroundColor:'#F6FBF9'}}  class=" flex flex-col absolute  justify-center items-center  px-4 py-8  rounded-3xl shadow sm:px-6 md:px-8 lg:px-10">
